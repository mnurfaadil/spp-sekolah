                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div style="float:right;">
                                      <a href="<?php echo e(route('pdf.print','pemasukan')); ?>" style="color:white; margin-top:0" class=" btn btn-info" target="_blank"><i class="fa fa-print"></i>&nbsp; Cetak</a>
                                ...
                                <?php $__currentLoopData = $datas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td>
                                          ...
                                          <a href="<?php echo e(route('income.destroy',$data)); ?>" class="btn btn-danger" onclick="event.preventDefault();destroy('<?php echo e(route('income.destroy',$data)); ?>');" title="Hapus"><i class="fa fa-trash"></i> Hapus</a>
                                        </td>
                                    </tr>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="basic-login-form-ad">
        <form action="<?php echo e(route('income.store')); ?>" role="form" method="post" enctype="multipart/form-data">
...
<?php $__env->startPush('scripts'); ?>
    ...
    function editConfirm(id,title,description,sumber,nominal)
    {
        ...
        $('#editPengeluaran').attr('action',"<?php echo e(url('income')); ?>/"+id)
        $('#modalUpdate').modal();
    }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u5982481/public_html/spp-sekolah/core/resources/views/pemasukan/index.blade.php ENDPATH**/ ?>