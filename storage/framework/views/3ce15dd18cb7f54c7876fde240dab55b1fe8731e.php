                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php echo e(number_format($data->besaran, 0, ",", ".")); ?>

                                            </div>
                                        </td>
                                        <td>
                                            <div style="text-align: center"><?php echo e($data->jenis); ?></div>
                                        </td>
                                        <td>
                                        <div style="text-align: center">
                                            <?php if($data->jenis=='Bayar per Bulan'): ?>
                                            <a href="<?php echo e(route('financing.periode',$data)); ?>" class="btn btn-success" title="Periode"><i class="fa fa-history"> Periode</i></a>
                                            <?php endif; ?>
                                            <?php if($data->history->count()>1): ?>
                                            <a href="#" class="btn btn-info"
                                                onclick="history('<?php echo e($data->nama); ?>','<?php echo e(number_format($data->besaran, 0, ",", ".")); ?>', '<?php echo e($data->jenis); ?>','<?php echo e(url('financing/history',$data->id)); ?>')"
                                                title="History"><i class="fa fa-history"> History</i></a>
                                            <?php endif; ?>
                                            <a href="#" class="btn btn-warning"
                                                onclick="editConfirm( '<?php echo e($data->id); ?>', '<?php echo e($data->nama); ?>', '<?php echo e($data->besaran); ?>', '<?php echo e($data->jenis); ?>')"
                                                title="Edit"><i class="fa fa-edit"> Edit</i></a>
                                            <a href="<?php echo e(route('financing.destroy',$data)); ?>" class="btn btn-danger"
                                                onclick="event.preventDefault();destroy('<?php echo e(route('financing.destroy',$data)); ?>');"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u5982481/public_html/spp-sekolah/core/resources/views/master/financingcategory/index.blade.php ENDPATH**/ ?>