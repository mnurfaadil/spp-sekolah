                            ...
                            <table id="table" data-toggle="table" data-pagination="true" data-search="true"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><div style="text-align:center;vertical-align:middle;"><?php echo e($data->email); ?></div></td>
                                        <td><div style="text-align:center"><?php echo e($data->created_at); ?></div></td>
                                        <td>
                                            <div style="text-align:center">
                                              <a href="#" class="btn btn-info"
                                              onclick="editConfirm( '<?php echo e($data->id); ?>', '<?php echo e($data->name); ?>', '<?php echo e($data->username); ?>','<?php echo e($data->email); ?>')"
                                              title="Edit"><i class="fa fa-edit"> Edit</i></a>
                                              <a href="<?php echo e(route('user.destroy',$data)); ?>" class="btn btn-danger"
                                              onclick="event.preventDefault();destroy('<?php echo e(route('user.destroy',$data)); ?>');"
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('user.store')); ?>" role="form" method="post">
...
<script>
    function editConfirm(id, nama, username, email) 
    {
      ...
      $('#editForm').attr('action',"<?php echo e(url('users')); ?>/"+id)
      $('#modalUpdate').modal();
    }
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u5982481/public_html/spp-sekolah/core/resources/views/master/user/index.blade.php ENDPATH**/ ?>