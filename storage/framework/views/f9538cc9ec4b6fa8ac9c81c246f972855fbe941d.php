                        ...
                        <div class="container-sm">
                            <div class="row">
                                ...
                                <div style="float:right;">
                                      <a href="<?php echo e(route('pdf.print','pengeluaran')); ?>" style="color:white; margin-top:0" class=" btn btn-info" target="_blank"><i class="fa fa-print"></i>&nbsp; Cetak</a>
                                ...
                                <?php $__currentLoopData = $datas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td class="avatar text-center">
                                          <img class="rounded-circle" style="width: 100px; height: 100px;" src="nota/<?php echo e($data -> foto); ?>" alt="">  
                                        </td>
                                        ...
                                        <td>
                                          <a href="#" class="btn btn-warning" onclick="editConfirm( '<?php echo e($data->id); ?>','<?php echo e($data->title); ?>','<?php echo e($data->description); ?>','<?php echo e($data->sumber); ?>','<?php echo e($data->nominal); ?>')" title="Edit"><i class="fa fa-edit"> Edit</i></a>
                                          <a href="<?php echo e(route('expense.destroy',$data)); ?>" class="btn btn-danger" onclick="event.preventDefault();destroy('<?php echo e(route('expense.destroy',$data)); ?>');" title="Hapus"><i class="fa fa-trash"></i> Hapus</a>
                                        </td>
                                    </tr>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="basic-login-form-ad">
        <form action="<?php echo e(route('expense.store')); ?>" role="form" method="post" enctype="multipart/form-data">
...
<?php $__env->startPush('scripts'); ?>
    ...
    function editConfirm(id,title,description,sumber,nominal)
    {
        ...
        $('#editPengeluaran').attr('action',"<?php echo e(url('expense')); ?>/"+id)
        $('#modalUpdate').modal();
    }
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u5982481/public_html/spp-sekolah/core/resources/views/pengeluaran/index.blade.php ENDPATH**/ ?>