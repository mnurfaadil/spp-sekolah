...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title><?php echo $__env->yieldContent('title-html'); ?></title>
    <style>
  ...
  <body>
    <header class="clearfix">
      <div >
        ...
        <br>
          <img style="hight:70; width:70;" src="<?php echo e(asset('assets/img/logo/bbl.png')); ?>" />
        </div>
        ...
        <hr class="garis_dua">
        <center><h3><?php echo $__env->yieldContent('title'); ?></h3></center>
        <?php echo $__env->yieldContent('content'); ?>	
  </body>
</html><?php /**PATH /home/u5982481/public_html/spp-sekolah/core/resources/views/export/layout/landscape.blade.php ENDPATH**/ ?>