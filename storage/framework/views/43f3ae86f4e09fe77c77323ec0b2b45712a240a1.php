                        ...
                        <div class="datatable-dashv1-list custom-datatable-overright">
                            ...
                            <table id="table" data-toggle="table" data-pagination="true" data-search="true"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td></td>
                                        <td><div style="text-align: center"><?php echo e($no++); ?></div></td>
                                        <td><?php echo e($data->nama); ?>&nbsp;
                                        <?php if($data->tunggakan): ?>
                                        <span class="badge" style="background-color:red;color:white;cursor:help" title="<?php echo e($data->tunggakan); ?> tunggakan di pembayaran <?php echo e($data->nama); ?>"><?php echo e($data->tunggakan); ?></span>
                                        <?php elseif($data->tunggakan_periode): ?>
                                        <span class="badge" style="background-color:red;color:white;cursor:help" title="<?php echo e($data->tunggakan_periode); ?> tunggakan di pembayaran <?php echo e($data->nama); ?>"><?php echo e($data->tunggakan_periode); ?></span>
                                        <?php endif; ?>
                                        </td>
                                        <td><div style="text-align: center"><?php echo e($data->jenis); ?></div></td>
                                        <td><div style="text-align: right"><?php echo e(number_format($data->besaran)); ?></div></td>
                                        <td>
                                            <div style="text-align: center;">
                                                <a href="<?php echo e(route('payment.show',$data->id)); ?>" class="btn btn-success"
                                                title="Proses pembayaran <?php echo e($data->nama); ?>" style="color:white"><i class="fa fa-history"> Process</i></a>
                                            </div>
                                        </td>
                                    </tr>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('financing.store')); ?>" role="form" method="post">
...
<script>
    function editConfirm(id, nama, besaran) {
        ...
        $('#editForm').attr('action', "<?php echo e(url('financing')); ?>/" + id);
        $('#modalUpdate').modal();
    }
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u5982481/public_html/spp-sekolah/core/resources/views/pembayaran/index.blade.php ENDPATH**/ ?>