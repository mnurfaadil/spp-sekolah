    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $categories = FinancingCategory::join('financing_periodes','financing_periodes.financing_category_id','=','financing_categories.id')
                            ->join('angkatans','angkatans.id','=','financing_periodes.angkatan_id')
                            ->groupBy(['financing_categories.id','financing_periodes.angkatan_id'])
                            ...
                            financing_periodes.nominal, angkatans.status')
                            ->get();
