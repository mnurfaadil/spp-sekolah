...
class HomeController extends Controller
{
    ...
    public function logout(){
        Session::flush();
        return redirect('login')->with('success', 'Terima kasih atas kerja keras anda!');
    }
    ...
    public function change(Request $request){
        ...
        try {
          ...
          return redirect('/home')->with('error', $e->toString());
        }
    }
    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('password.edit')->with('error', 'Password lama salah');
        }
        return redirect()->route('password.edit')->with('error', 'Password lama salah');
    }
