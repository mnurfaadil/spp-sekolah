...
class RekapController extends Controller
{
    ...
    {
        $categorys = FinancingCategory::join('payments','payments.financing_category_id','=','financing_categories.id')->join('payment_details','payment_details.payment_id','=','payments.id')->selectRaw('financing_categories.*')->where('payment_details.status','Nunggak')->groupBy('financing_categories.id')->get();
