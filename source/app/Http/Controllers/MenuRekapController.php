...
class MenuRekapController extends Controller
{
    ...
    {
        $no = 1;
        $datas = Pencatatan::orderBy('pencatatans.updated_at', 'desc')->join('incomes','incomes.id','=','pencatatans.income_id')->where([['debit','<>','0'],])->get();
        $filter = '';
        $pilihan = '';
    ...
    public function indexPemasukanFilter(Request $request)
    {
        ...
        switch ($request->filter) {
            case 'harian':
                //Query Filter Harian
                $datas = Pencatatan::orderBy('incomes.updated_at', 'desc')->join('incomes','incomes.id','=','pencatatans.income_id')->whereDate('incomes.created_at', $request->pilihan)->get();
                break;
            ...
            case 'bulanan':
                ...
                $_temp = explode('-', $temp);
                $datas = Pencatatan::orderBy('incomes.updated_at', 'desc')->join('incomes','incomes.id','=','pencatatans.income_id')->whereMonth('incomes.created_at', $_temp[1])->whereYear('incomes.created_at', $_temp[0])->get();
                break;

            case 'tahunan':
                //Query Filter Tahun
                $datas = Pencatatan::orderBy('incomes.updated_at', 'desc')->join('incomes','incomes.id','=','pencatatans.income_id')->whereYear('incomes.created_at', '=', $request->pilihan)->where([['debit','<>','0'],])->get();
                break;
            
            default:
                //Query Filter Tahun
                $datas = Pencatatan::orderBy('incomes.updated_at', 'desc')->join('incomes','incomes.id','=','pencatatans.income_id')->where([['debit','<>','0'],])->get();
        }
        return view('export.menu.pemasukan',compact('no','datas', 'filter', 'pilihan'));
    }
    ...
    {
        $no = 1;
        $datas = Expense::orderBy('expenses.updated_at', 'desc')->get();
        $filter = '';
        $pilihan = '';
    ...
    public function indexPengeluaranFilter(Request $request)
    {
        ...
        switch ($request->filter) {
            case 'harian':
                //Query Filter Harian
                $datas = Expense::orderBy('expenses.updated_at', 'desc')->whereDate('expenses.created_at', $request->pilihan)->get();
                break;
            ...
            case 'bulanan':
                ...
                $temp = $request->pilihan;
                $_temp = explode('-', $temp);
                $datas = Expense::orderBy('expenses.updated_at', 'desc')->whereMonth('expenses.created_at', $_temp[1])->whereYear('expenses.created_at', $_temp[0])->get();
                break;

            case 'tahunan':
                //Query Filter Tahun
                $datas = Expense::orderBy('expenses.updated_at', 'desc')->whereYear('expenses.created_at', '=', $request->pilihan)->get();
                break;
            default:
                $datas = Expense::orderBy('expenses.updated_at', 'desc')->get();
        }
    ...
    {
        if ($stat == 'Siswa') {
            return DB::table('payment_details')->select(DB::raw('financing_categories.id as financing_category_id, payment_details.id as detail_id, payment_details.payment_id, payment_details.payment_periode_id, angkatans.id as angkatan_id, majors.id as major_id, students.nama as nama_murid, students.kelas, angkatans.angkatan, angkatans.tahun as tahun_angkatan, majors.inisial as inisial, majors.nama as jurusan, financing_categories.nama, count(payment_details.status) as banyak_tunggakan, financing_periodes.nominal, getNominalCicilan(payment_details.id) as cicilan_dibayar, payments.jenis_pembayaran, payments.persentase, payment_details.status'))->join('payments', 'payments.id', '=', 'payment_details.payment_id')->join('financing_periodes', 'financing_periodes.id', '=', 'payment_details.payment_periode_id')->join('financing_categories', 'financing_categories.id', '=', 'payments.financing_category_id')->join('students', 'students.id', '=', 'payments.student_id')->join('majors', 'majors.id', '=', 'students.major_id')->join('angkatans', 'angkatans.id', '=', 'students.angkatan_id')->orderBy('students.id')->groupBy('payment_details.payment_id')->where('payment_details.status','<>','Lunas')->get();
        }
        else
        {
            return DB::table('payment_details')->select(DB::raw('financing_categories.id as financing_category_id, payment_details.id as detail_id, payment_details.payment_id, payment_details.payment_periode_id, angkatans.id as angkatan_id, majors.id as major_id, students.nama as nama_murid, students.kelas, angkatans.angkatan, angkatans.tahun as tahun_angkatan, majors.inisial as inisial, majors.nama as jurusan, financing_categories.nama, count(payment_details.status) as banyak_tunggakan, financing_periodes.nominal, getNominalCicilan(payment_details.id) as cicilan_dibayar, payments.jenis_pembayaran, payments.persentase, payment_details.status'))->join('payments', 'payments.id', '=', 'payment_details.payment_id')->join('financing_periodes', 'financing_periodes.id', '=', 'payment_details.payment_periode_id')->join('financing_categories', 'financing_categories.id', '=', 'payments.financing_category_id')->join('students', 'students.id', '=', 'payments.student_id')->join('majors', 'majors.id', '=', 'students.major_id')->join('angkatans', 'angkatans.id', '=', 'students.angkatan_id')->orderBy('financing_categories.id')->groupBy('payment_details.payment_id')->where('payment_details.status','<>','Lunas')->get();
        }
    }

    public static function nominalRekapTunggakan()
    {
        $datas = DB::table('payment_details')->select(DB::raw('financing_categories.nama, financing_categories.jenis, count(payment_details.status) as banyak_tunggakan, financing_periodes.nominal, getNominalCicilan(payment_details.id) as cicilan_dibayar, payments.jenis_pembayaran, payments.jenis_potongan, payments.nominal_potongan, payments.persentase'))->join('payments', 'payments.id', '=', 'payment_details.payment_id')->join('financing_periodes', 'financing_periodes.id', '=', 'payment_details.payment_periode_id')->join('financing_categories', 'financing_categories.id', '=', 'payments.financing_category_id')->orderBy('financing_categories.id')->groupBy('payment_details.payment_id')->where('payment_details.status','<>','Lunas')->where('financing_categories.jenis','<>','Bayar per Bulan')->get();
        $total = 0;
        foreach ($datas as $i => $data) {
            ...
            if ($data->jenis === 'Bayar per Bulan')
            {
                ...
                $besaran_ = $bulan_spp * intval($data->nominal);
                $terbayar_ = ($bulan_spp - intval($data->banyak_tunggakan)) * $besaran_;
                $potongan_ = 0;
            }
        ...
        $datas = DB::table('payment_details')->select(DB::raw('sum(payment_details.nominal_bayar) as besaran, sum(payment_details.nominal) as terbayar'))->join('payments', 'payments.id', '=', 'payment_details.payment_id')->join('financing_periodes', 'financing_periodes.id', '=', 'payment_details.payment_periode_id')->join('financing_categories', 'financing_categories.id', '=', 'payments.financing_category_id')->where('financing_categories.jenis','<>','Sekali Bayar')->first();
        $total = $total + (intval($datas->besaran) - intval($datas->terbayar));
        return $total;
    }
    ...
    public static function nominalRekapTunggakanArray()
    {
        ...
        $datas = DB::table('payment_details')->select(DB::raw('sum(payment_details.nominal_bayar) as besaran, sum(payment_details.nominal) as terbayar'))->join('payments', 'payments.id', '=', 'payment_details.payment_id')->join('financing_periodes', 'financing_periodes.id', '=', 'payment_details.payment_periode_id')->join('financing_categories', 'financing_categories.id', '=', 'payments.financing_category_id')->where('financing_categories.jenis','<>','Sekali Bayar')->first();
        $total [0] += intval($datas->besaran);
        $total [2] += intval($datas->terbayar);
        $total [3] += (intval($datas->besaran) - intval($datas->terbayar));
        return $total;
    }
    ...
    public function ajaxTunggakanMaster($stat = 'Siswa')
    {
        ...
        if ( $search=='' ) {
            $data = Payment::limit($limit)->offset($offset)->orderBy($sort, $order)->get();
        } else {
            $data = Payment::limit($limit)->join('students', 'students.id', '=', 'payments.student_id')->offset($offset)->where('students.nama', 'like', '%' .$search. '%')->get();
        }
    ...
    public function indexTunggakanFilter(Request $request, $stat = 'Siswa')
    {
        ...
        if ($stat == 'Siswa')
        {
            ...
            {
                $datas = DB::table('payment_details')->select(DB::raw('financing_categories.id as financing_category_id, payment_details.id as detail_id, payment_details.payment_id, payment_details.payment_periode_id, angkatans.id as angkatan_id, majors.id as major_id, students.nama as nama_murid, students.kelas, angkatans.angkatan, angkatans.tahun as tahun_angkatan, majors.inisial as inisial, majors.nama as jurusan,financing_categories.nama, count(payment_details.status) as banyak_tunggakan, financing_periodes.nominal, getNominalCicilan(payment_details.id) as cicilan_dibayar, payments.jenis_pembayaran, payments.persentase, payment_details.status'))->join('payments', 'payments.id', '=', 'payment_details.payment_id')->join('financing_periodes', 'financing_periodes.id', '=', 'payment_details.payment_periode_id')->join('financing_categories', 'financing_categories.id', '=', 'payments.financing_category_id')->join('students', 'students.id', '=', 'payments.student_id')->join('majors', 'majors.id', '=', 'students.major_id')->join('angkatans', 'angkatans.id', '=', 'students.angkatan_id')->orderBy('students.id')->groupBy('payment_details.payment_id')->where('payment_details.status','<>','Lunas')->get();
            }
            else if ($kelas != 'all' && $jurusan == 'all' && $angkatan == 'all')
            {
                $datas = DB::table('payment_details')->select(DB::raw('financing_categories.id as financing_category_id, payment_details.id as detail_id, payment_details.payment_id, payment_details.payment_periode_id, angkatans.id as angkatan_id, majors.id as major_id, students.nama as nama_murid, students.kelas, angkatans.angkatan, angkatans.tahun as tahun_angkatan, majors.inisial as inisial, majors.nama as jurusan, financing_categories.nama, count(payment_details.status) as banyak_tunggakan, financing_periodes.nominal, getNominalCicilan(payment_details.id) as cicilan_dibayar, payments.jenis_pembayaran, payments.persentase, payment_details.status'))->join('payments', 'payments.id', '=', 'payment_details.payment_id')->join('financing_periodes', 'financing_periodes.id', '=', 'payment_details.payment_periode_id')->join('financing_categories', 'financing_categories.id', '=', 'payments.financing_category_id')->join('students', 'students.id', '=', 'payments.student_id')->join('majors', 'majors.id', '=', 'students.major_id')->join('angkatans', 'angkatans.id', '=', 'students.angkatan_id')->orderBy('students.id')->groupBy('payment_details.payment_id')->where('payment_details.status','<>','Lunas')->where('students.kelas','=', $kelas)->get();
            }
            else if ($kelas == 'all' && $jurusan != 'all' && $angkatan == 'all')
            {
                $datas = DB::table('payment_details')->select(DB::raw('financing_categories.id as financing_category_id, payment_details.id as detail_id, payment_details.payment_id, payment_details.payment_periode_id, angkatans.id as angkatan_id, majors.id as major_id, students.nama as nama_murid, students.kelas, angkatans.angkatan, angkatans.tahun as tahun_angkatan, majors.inisial as inisial, majors.nama as jurusan, financing_categories.nama, count(payment_details.status) as banyak_tunggakan, financing_periodes.nominal, getNominalCicilan(payment_details.id) as cicilan_dibayar, payments.jenis_pembayaran, payments.persentase, payment_details.status'))->join('payments', 'payments.id', '=', 'payment_details.payment_id')->join('financing_periodes', 'financing_periodes.id', '=', 'payment_details.payment_periode_id')->join('financing_categories', 'financing_categories.id', '=', 'payments.financing_category_id')->join('students', 'students.id', '=', 'payments.student_id')->join('majors', 'majors.id', '=', 'students.major_id')->join('angkatans', 'angkatans.id', '=', 'students.angkatan_id')->orderBy('students.id')->groupBy('payment_details.payment_id')->where('payment_details.status','<>','Lunas')->where('majors.id','=', $jurusan)->get();
            }
            else if ($kelas == 'all' && $jurusan == 'all' && $angkatan != 'all')
            {
                $datas = DB::table('payment_details')->select(DB::raw('financing_categories.id as financing_category_id, payment_details.id as detail_id, payment_details.payment_id, payment_details.payment_periode_id, angkatans.id as angkatan_id, majors.id as major_id, students.nama as nama_murid, students.kelas, angkatans.angkatan, angkatans.tahun as tahun_angkatan, majors.inisial as inisial, majors.nama as jurusan, financing_categories.nama, count(payment_details.status) as banyak_tunggakan, financing_periodes.nominal, getNominalCicilan(payment_details.id) as cicilan_dibayar, payments.jenis_pembayaran, payments.persentase, payment_details.status'))->join('payments', 'payments.id', '=', 'payment_details.payment_id')->join('financing_periodes', 'financing_periodes.id', '=', 'payment_details.payment_periode_id')->join('financing_categories', 'financing_categories.id', '=', 'payments.financing_category_id')->join('students', 'students.id', '=', 'payments.student_id')->join('majors', 'majors.id', '=', 'students.major_id')->join('angkatans', 'angkatans.id', '=', 'students.angkatan_id')->orderBy('students.id')->groupBy('payment_details.payment_id')->where('payment_details.status','<>','Lunas')->where('angkatans.id','=', $angkatan)->get();
            }
            else if ($kelas != 'all' && $jurusan != 'all' && $angkatan == 'all')
            {
                $datas = DB::table('payment_details')->select(DB::raw('financing_categories.id as financing_category_id,payment_details.id as detail_id, payment_details.payment_id, payment_details.payment_periode_id, angkatans.id as angkatan_id, majors.id as major_id, students.nama as nama_murid, students.kelas, angkatans.angkatan, angkatans.tahun as tahun_angkatan, majors.inisial as inisial, majors.nama as jurusan, financing_categories.nama, count(payment_details.status) as banyak_tunggakan, financing_periodes.nominal, getNominalCicilan(payment_details.id) as cicilan_dibayar, payments.jenis_pembayaran, payments.persentase, payment_details.status'))->join('payments', 'payments.id', '=', 'payment_details.payment_id')->join('financing_periodes', 'financing_periodes.id', '=', 'payment_details.payment_periode_id')->join('financing_categories', 'financing_categories.id', '=', 'payments.financing_category_id')->join('students', 'students.id', '=', 'payments.student_id')->join('majors', 'majors.id', '=', 'students.major_id')->join('angkatans', 'angkatans.id', '=', 'students.angkatan_id')->orderBy('students.id')->groupBy('payment_details.payment_id')->where('payment_details.status','<>','Lunas')->where('students.kelas','=', $kelas)->where('majors.id','=', $jurusan)->get();
            }
            else if ($kelas != 'all' && $jurusan == 'all' && $angkatan != 'all')
            {
                $datas = DB::table('payment_details')->select(DB::raw('financing_categories.id as financing_category_id,payment_details.id as detail_id, payment_details.payment_id, payment_details.payment_periode_id, angkatans.id as angkatan_id, majors.id as major_id, students.nama as nama_murid, students.kelas, angkatans.angkatan, angkatans.tahun as tahun_angkatan, majors.inisial as inisial, majors.nama as jurusan, financing_categories.nama, count(payment_details.status) as banyak_tunggakan, financing_periodes.nominal, getNominalCicilan(payment_details.id) as cicilan_dibayar, payments.jenis_pembayaran, payments.persentase, payment_details.status'))->join('payments', 'payments.id', '=', 'payment_details.payment_id')->join('financing_periodes', 'financing_periodes.id', '=', 'payment_details.payment_periode_id')->join('financing_categories', 'financing_categories.id', '=', 'payments.financing_category_id')->join('students', 'students.id', '=', 'payments.student_id')->join('majors', 'majors.id', '=', 'students.major_id')->join('angkatans', 'angkatans.id', '=', 'students.angkatan_id')->orderBy('students.id')->groupBy('payment_details.payment_id')->where('payment_details.status','<>','Lunas')->where('angkatans.id','=', $angkatan)->where('students.kelas','=', $kelas)->get();
            }
            else if ($kelas == 'all' && $jurusan != 'all' && $angkatan != 'all')
            {
                $datas = DB::table('payment_details')->select(DB::raw('financing_categories.id as financing_category_id, payment_details.id as detail_id, payment_details.payment_id, payment_details.payment_periode_id, angkatans.id as angkatan_id, majors.id as major_id, students.nama as nama_murid, students.kelas, angkatans.angkatan, angkatans.tahun as tahun_angkatan,majors.inisial as inisial,majors.nama as jurusan, financing_categories.nama,  count(payment_details.status) as banyak_tunggakan, financing_periodes.nominal, getNominalCicilan(payment_details.id) as cicilan_dibayar, payments.jenis_pembayaran, payments.persentase, payment_details.status'))->join('payments', 'payments.id', '=', 'payment_details.payment_id')->join('financing_periodes', 'financing_periodes.id', '=', 'payment_details.payment_periode_id')->join('financing_categories', 'financing_categories.id', '=', 'payments.financing_category_id')->join('students', 'students.id', '=', 'payments.student_id')->join('majors', 'majors.id', '=', 'students.major_id')->join('angkatans', 'angkatans.id', '=', 'students.angkatan_id')->orderBy('students.id')->groupBy('payment_details.payment_id')->where('payment_details.status','<>','Lunas')->where('angkatans.id','=', $angkatan)->where('majors.id','=', $jurusan)->get();
            }
            else
            {
