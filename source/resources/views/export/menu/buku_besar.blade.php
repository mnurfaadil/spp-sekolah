                ...
                <div class="sparkline13-list">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            ...
                            <div class="row">
                                    <div class="col-md-6">
                                        <form action="{{route('rekap.bukbes.filter')}}" role="form" method="post">
                                        @csrf
                                    ...
                                    <div class="col-md-6">
                                        <form action="{{route('rekap.bukbes.export')}}" target="_blank" role="form" id="cetak" method="post">
                                            @csrf
                            ...
                            <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="debit"><div style="text-align:center;">Debit</div></th>
                                        <th data-field="kredit"><div style="text-align:center;">Kredit</div></th>
                                        <th data-field="saldo"><div style="text-align:center;">Saldo</div></th>
                                    </tr>
                                </thead>
                                    <tbody>
                                        @php
                                                                    ...
                                                                    <td>
                                                                        <div style="text-align: right">
                                                                            <span class="" style="font-size:18px;">
                                                                                <strong>{{number_format($total_debit,0,',','.')}}</strong></span>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    ...
                                                                    <td style="border-bottom: 1px solid #000;">
                                                                        <div style="text-align: right">
                                                                            <span class="" style="font-size:18px;">
                                                                                <strong>{{number_format($total_kredit,0,',','.')}}</strong></span>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                                <tr>
        ...
        <script>
            function change_filter() {
                ...
                else
                {
                    ...
                    $('input[type=hidden][name=filter]').val(filter);
                    $.get(`{{ url('') }}/rekap_bukbes/ajax/${filter}`, function(data){
