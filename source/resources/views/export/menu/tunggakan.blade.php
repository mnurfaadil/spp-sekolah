    ...
    <div class="container-fluid">
                ...
                <div class="sparkline13-list">
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            ...
                            <div class="row">
                                    <div class="col-md-6">
                                        <form action="{{route('rekap.pengeluaran.filter')}}" role="form" method="post">
                                        @csrf
                                    ...
                                    <div class="col-md-6">
                                        <form action="{{route('rekap.pengeluaran.export')}}" target="_blank" role="form" id="cetak" method="post">
                                            @csrf
        ...
        <script>
            function change_filter() {
                ...
                else
                {
                    ...
                    $('input[type=hidden][name=filter]').val(filter);
                    $.get(`{{ url('') }}/rekap_Pengeluaran/ajax/${filter}`, function(data){
        ...
        <div class="col-md-11">
            <div style="margin-left:15px;">
                <h3>Data Laporan Pengeluaran</h3>
            </div>
        </div>
        @endpush
