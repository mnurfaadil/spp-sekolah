        ...
        <div class="left-custom-menu-adp-wrap comment-scrollbar">
            <nav class="sidebar-nav left-sidebar-menu-pro">
                ...
                @if(Auth::user()->role=="Sekolah")
                    ...
                    <li>
                        @if(Request::is('rekap') || Request::is('rekap_tunggakan') || Request::is('export') || Request::is('rekap_bukbes')|| Request::is('rekap_Pemasukan')|| Request::is('rekap_Pengeluaran'))
                    ...
                    <li>
                        ...
                        <ul class="submenu-angle" aria-expanded="false">
                            ...
                            <li><a title="Data Master Kategori Pembiayaan" href="{{ url('registrasi') }}"><span class="mini-sub-pro">Registrasi Pembayaran</span></a></li>
                        </ul>
                    </li>
