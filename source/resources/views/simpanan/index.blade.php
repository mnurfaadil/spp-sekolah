                    ...
                    <div class="sparkline13-hd">
                        <div class="main-sparkline13-hd">
                            <div class="container-sm">
                                <div class="row">
                                    <div class="col-md-6">
                                        <form action="{{route('simpanan.filter')}}" role="form" method="post">
                                        @csrf
                                    ...
                                    <div class="col-md-6">
                                        <div style="float:right;">
                                            ...
                                            <h3><span style="color:green;">Rp. {{number_format($students->sum('simpanan'),0,',','.')}}</span></h3>
                                        </div>
                                    </div>
                            </div>
                        </div>
                            ...
                            <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-field="simpanan"><div style="text-align:center;">Simpanan</div></th>
                                    </tr>
                                </thead>
                                <tbody>
                                @if(isset($students))
                                @foreach($students as $data)
                                    <tr>
                                        ...
                                        <td><div style="text-align:right;">{{number_format($data->simpanan,0,',','.')}}</div></td>
                                    </td>
                                    </tr>
                                    @endforeach
                                    @endif
